...
@section('body')
    <div class="login-box">
        <div class="login-logo" style="margin-bottom: 1px;">
            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}">SGA <b>{{ __('lms.words.teacher') }}</b></a>
            <img src="{{ url('/images/ministerio_de_education_logo.jpg') }}" width="360" align="{{ config('adminlte.title') }}"/>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">{{ __('lms.messages.m_ad_user_login') }}</p>
            <form action="{{ url('students/login') }}" method="post">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a class="text-right" href="{{ url('login') }}">{{ __('lms.messages.m_au_user_login') }}</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-8">
