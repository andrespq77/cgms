    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-file-o"></i> <span class="js-modal-title">Editar Cantón</span></h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <label for="js-edit-canton-name" class="col-md-2 control-label">Nombre del Cantón</label>
                                <div class="col-md-4">
