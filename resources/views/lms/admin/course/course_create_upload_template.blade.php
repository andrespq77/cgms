<script type="text/template" id="qq-new-course-template-manual-trigger">
    <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here.">
        ...
        <div class="buttons">
            ...
            <button type="button" id="btn-upload-new-course-list" class="btn btn-primary">
        ...
        <dialog class="qq-alert-dialog-selector">
            ...
            <div class="qq-dialog-buttons">
                <button type="button" class="qq-cancel-button-selector">{{ __('lms.elements.button.finish') }}</button>
            </div>
        </dialog>
...
<style>
    ...
    #btn-upload-new-course-list{
        margin-left: 15px;
    }

    #btn-upload-new-course-list .buttons {
        width: 36%;
    }

    #btn-upload-new-course-list .qq-uploader .qq-total-progress-bar-container {
        width: 60%;
    }
</style>
