<script type="text/template" id="disclaimer_upload_template-trigger">
    <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Suelte sus archivos aqui">
        ...
        <div class="buttons">
            ...
            <button type="button" id="btn-trigger-disclaimer-upload" class="btn btn-primary">
