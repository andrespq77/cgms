<script type="text/template" id="qq-registration-release-file-template-manual-trigger">
    <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here.">
        ...
        <div class="buttons">
            ...
            <button type="button" id="btn-upload-registration-release-file" class="btn btn-primary">
...
<style>
    #btn-upload-registration-release-file {
        color: white;
    ...
    #registration_release_file_upload .buttons{
        margin-bottom: 40px;
        width: 100%;
    }

    #registration_release_file_upload .qq-uploader{
        width: 100%;
    }

    #registration_release_file_upload .qq-upload-button{
        margin-right: 15px;
    }

    #qq-registration-release-file-template-manual-trigger .qq-uploader .qq-total-progress-bar-container {
        width: 60%;
    }
</style>
